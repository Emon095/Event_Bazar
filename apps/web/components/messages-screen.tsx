...
export function MessagesScreen() {
  ...
  return <main className="messages-page"><header className="messages-nav"><Link href="/" aria-label="Back to events"><ArrowLeft/></Link><Logo/><span className="messages-nav-icon"><MessageCircle/></span></header><section className="messages-shell">
