...
export function MessagesScreen() {
  ...
  return <main className="messages-page"><div className="ambient messages-ambient" aria-hidden="true"><i/><i/><i/><i/></div><header className="messages-nav"><Link href="/" aria-label="Back to events"><ArrowLeft/></Link><Logo/><span className="messages-nav-icon"><MessageCircle/></span></header><section className="messages-shell">
