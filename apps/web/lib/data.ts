...
export const events: EventItem[] = [
  {
    ...
    startsAt: "2026-08-08T20:00:00+06:00", deadline: "2026-08-07T23:59:00+06:00", prize: "$12,000", teamSize: "1–4", difficulty: "All levels", format: "Online", location: "Worldwide", interested: 2841, comments: 128, featured: true, tags: ["Jeopardy", "Beginner friendly", "Global"]
  },
  {
    ...
    startsAt: "2026-08-15T09:00:00+06:00", deadline: "2026-08-10T23:59:00+06:00", prize: "৳300K", teamSize: "3", difficulty: "Advanced", format: "Offline", location: "Dhaka, Bangladesh", interested: 1934, comments: 76, tags: ["Algorithms", "University", "Bangladesh"]
  },
  {
    ...
    startsAt: "2026-09-04T18:00:00+06:00", deadline: "2026-08-24T23:59:00+06:00", prize: "৳1M", teamSize: "2–5", difficulty: "Intermediate", format: "Hybrid", location: "Dhaka + Online", interested: 3748, comments: 204, featured: true, tags: ["Climate", "Civic tech", "Mentorship"]
  },
  {
    ...
    startsAt: "2026-08-02T16:00:00+06:00", deadline: "2026-08-01T20:00:00+06:00", prize: "Free", teamSize: "Solo", difficulty: "Beginner", format: "Online", location: "Google Meet", interested: 892, comments: 43, tags: ["AI", "Hands-on", "Free"]
  },
  {
    ...
    startsAt: "2026-08-01T20:35:00+06:00", deadline: "2026-08-01T20:30:00+06:00", prize: "Rating", teamSize: "Solo", difficulty: "Intermediate", format: "Online", location: "Worldwide", interested: 1267, comments: 55, tags: ["Rated", "Algorithms", "Div. 2"]
  },
  {
    ...
    startsAt: "2026-09-12T10:00:00+06:00", deadline: "2026-09-10T23:59:00+06:00", prize: "Free", teamSize: "Solo", difficulty: "All levels", format: "Offline", location: "BICC, Dhaka", interested: 5210, comments: 312, tags: ["Career", "Networking", "Dhaka"]
  }
];

export const categoryStyle: Record<string, { icon: string; color: string }> = {
  CTF: { icon: "⌁", color: "violet" }, Programming: { icon: "</>", color: "blue" },
